...
export const selectSection = createAction('[Main Page] Select section', props<{ sections: Sections[]; }>());
export const searchInput = createAction('[Main Page] Search input', props<{ search: string; }>());
