import { PagedResults, ALL } from "./swapi.models";

export let people: PagedResults<ALL> = {
  count: 82,
...
export let starships: PagedResults<ALL> = {
  count: 36,
  next: 'https://swapi.dev/api/starships/?search=&page=2',
  previous: null,
  results: [
    {
      name: 'CR90 corvette',
...
export let planets: PagedResults<ALL> = {
  count: 60,
